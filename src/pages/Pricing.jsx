...
export default function Pricing() {
  ...
  return <>
    ...
    <section className="section soft-section"><div className="container split-grid"><Reveal as="div" delay={0}><div className="section-heading"><span>Need a custom combination?</span><h2>Build around the services your business needs</h2></div><p>Each formation service also has its own page registered agent, EIN assistance, operating agreement, DBA filing, compliance support, and formation documents.</p><Link className="btn btn-primary" to="/services">Browse all services <ArrowRight size={18}/></Link></Reveal><Reveal as="div" delay={1} className="image-panel"><img src="/illustrations/compliance.svg" alt="Compliance service illustration"/></Reveal></div></section>
    <FAQ items={faqs}/>
  </>
}
