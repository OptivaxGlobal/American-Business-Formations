...
export default function Pricing() {
  ...
  const faqs = [
    ...
    ['Do state filing fees vary?', `Yes. LLC formation is available across all 50 states, Washington, D.C., and Puerto Rico, and each one sets its own filing fee currently ranging from $${filingFeeRange.min} to $${filingFeeRange.max}. Use the calculator below to see the fee for your state, or select your state during onboarding to see the exact amount.`],
  ...
  return <>
    <SEO title="Plans & Pricing" description="Transparent LLC formation pricing across all 50 states, Washington, D.C. & Puerto Rico service fees and state filing fees always shown separately." path="/pricing" jsonLd={faqSchema(faqs)} />
    ...
    <section className="section soft-section">
      <div className="container">
        <SectionHeading centered eyebrow="See your total" title="Estimate your state filing fee" description="Available across all 50 states, Washington, D.C. & Puerto Rico each one has its own government filing fee. Select a state and package to see an estimate the exact total is always confirmed again at checkout." />
        <StateFeeCalculator/>
      </div>
    </section>
