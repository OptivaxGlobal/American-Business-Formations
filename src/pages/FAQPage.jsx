...
const faqs = [
  ...
  ['Do you offer a business mailing address separate from a registered agent?', 'Yes. Our suite-based mail forwarding service provides a professional street address for general business mail, separate from the legal registered agent requirement, for $30 per month per entity.'],
