...
const faqs = [
  ...
  ['Which states do you support?', 'LLC formation is currently available in 21 states. Select your state during onboarding and the filing fee updates automatically. Business Formation Filings, our Registered Agent, and compliance services can extend to other states on request.'],
  ...
  ['Do you offer a business mailing address separate from a registered agent?', 'Yes, two options. Mail Forwarding provides a professional business address with a unique suite number, separate from the legal registered agent requirement, for $20 per month per entity. Virtual Office adds a signed lease agreement to that same service for $29 per month.'],
...
export default function FAQPage() {
  return <>
    <SEO title="Frequently Asked Questions" description="Answers to common questions about LLC formation across 21 states, registered agents, EINs, compliance, and your account." path="/faq" jsonLd={faqSchema(faqs)} />
    <PageHero
      crumbs={<Breadcrumbs items={[{ label: 'FAQ' }]} />}
      eyebrow="FAQ"
      title="Frequently asked questions"
      description="Search or browse answers about LLC formation across 21 states, compliance, and your account."
    />
