...
export const sampleApplications = [
  { id: 'app-demo-1', businessName: 'Northwind Consulting LLC (demo)', state: 'Texas', entityType: 'LLC', status: 'under-review', createdAt: '2026-07-10T00:00:00.000Z' },
  { id: 'app-demo-2', businessName: 'Harborline Goods Co (demo)', state: 'Texas', entityType: 'LLC', status: 'ready-to-file', createdAt: '2026-07-14T00:00:00.000Z' },
